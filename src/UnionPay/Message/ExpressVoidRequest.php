...
class ExpressVoidRequest extends BaseAbstractRequest
{
    ...
    {
        $this->validate('certPath', 'certPassword', 'orderId', 'txnTime', 'txnAmt', 'origQryId');
    }
    ...
    {
        $this->setParameter('origQryId', $value);
    }
